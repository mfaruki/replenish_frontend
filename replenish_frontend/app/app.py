...
from PIL import Image
import string
from functions import func, shopping_list
...
processed_df = pd.read_csv('/home/maaviya/code/mfaruki/replenish_frontend/replenish_frontend/raw_data/model_df_final.csv')
...
def intro():
    ...
    with row0_2:
        st.text("")
        # path = os.path.join(os.path.dirname(os.getcwd()),'raw_data')
        imagelogo = Image.open('/home/maaviya/code/mfaruki/replenish_frontend/replenish_frontend/raw_data/logo.jpg')
...
def output():
    ...
    with row7_2:
        ...
        if diet_pref != 'Select':
            diet_df= (processed_df[processed_df.combined.str.contains('vegan')])
